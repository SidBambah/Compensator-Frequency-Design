...
C_elec = (R3*C1*s + 1)/(s*R2*(C1 + C2 + R3*C1*C2*s)) %electrical controller transfer function -Vc/Vs
...
%Gp = tfest(data, 2)
C_mech = -0.1*(1+(3.38*10^4/5)/s)*((1+3.1715e-4*s)/(1+3.1529e-5*s))  % mechanical controller V_set/V_e   
